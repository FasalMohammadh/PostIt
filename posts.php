...
<!--#############################Table Starts here (bootstrap modal)##############################################-->
<div class="container">
 ...
 <table class="table table-dark">
      <thead>
                 <tr>
                   ...
                   <th scope="col">Poat ID</th>  
                   <th scope="col">Posts Text</th>                          
                   <th scope="col">Post Image Path</th>
         ...
         <tbody>
                 <tr>
                   ...
                   <td><?php echo $row['post_img_path'] ?></td>
...
<!--#############################Table ends here (bootstrap modal)##############################################-->

<!--#############################DELETE pop up form stsrts here(bootstrap modal)##############################################-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle"> Delete Posts</h5>
...
<!--###################################DELETE pop up form ends here (bootstrap modal)#############################################-->
